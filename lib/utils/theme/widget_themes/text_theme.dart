...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(fontSize: 24.0, fontWeight: FontWeight.normal, color: MFColors.dark),
    headlineSmall: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w400, color: MFColors.dark),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(fontSize: 24.0, fontWeight: FontWeight.normal, color: MFColors.light),
    headlineSmall: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w400, color: MFColors.light),
